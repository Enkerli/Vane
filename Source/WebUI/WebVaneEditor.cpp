...
const ParamPair kParamMap[] = {
    ...
    { "VowelEn", "vowelEnable" }, { "Vowel",   "vowelPos"    }, { "VowFront","vowelFront"  },
    { "VowRound","vowelRound"  }, { "VowelAmt","vowelAmount" }, { "VowelBite","vowelReso"  },
    { "VowelMove","vowelMove"  }, { "VowelMode","vowelMode"   },
